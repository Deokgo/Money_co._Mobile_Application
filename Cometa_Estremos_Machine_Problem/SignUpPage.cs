...
namespace Cometa_Estremos_Machine_Problem
{
    ...
    public class SignUpPage : AppCompatActivity
    {
        ...
        protected void SaveUserRecord(object sender, EventArgs e)
        {
            ...
            if (validData)
            {
                command.QueryCommand("http://192.168.1.4/MoneySendingApp/Functions/add_user_info.php?mobile_num=" + mobileNum + " &user_name=" + userName + " &user_password=" + passConfirm + " &acc_balance=" + accBalance);
