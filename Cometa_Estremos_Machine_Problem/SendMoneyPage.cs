    ...
    public class SendMoneyPage : AppCompatActivity
    {
        ...
        protected void SendMoneyBtn(object sender, EventArgs e)
        {
            ...
            if (validData)
            {
                ...
                command.QueryCommand("http://192.168.1.4/MoneySendingApp/Functions/update_user_balance.php?user_mobile_num=" + userMobileNum + " &user_acc_balance=" + newUserBalance);
                command.QueryCommand("http://192.168.1.4/MoneySendingApp/Functions/update_user_balance.php?user_mobile_num=" + resMobileNum + " &user_acc_balance=" + newResBalance);
