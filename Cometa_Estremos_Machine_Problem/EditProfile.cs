    ...
    public class EditProfile : AppCompatActivity
    {
        ...
        protected void ConfirmChanges(object sender, EventArgs e)
        {
            ...
            if (changeName.Checked)
            {
                ...
                {
                    command.QueryCommand("http://192.168.1.4/MoneySendingApp/Functions/update_user_name.php?user_mobile_num=" + userMobileNum + " &user_name=" + accName);
            ...
            if (changePass.Checked)
            {
                ...
                if (validData)
                {
                    command.QueryCommand("http://192.168.1.4/MoneySendingApp/Functions/update_user_password.php?user_mobile_num=" + userMobileNum + " &user_password=" + confirmPass);
        ...
        protected bool Validations()
        {
            ...
            else if (userPass != userData[1].Trim())
            { Toast.MakeText(this, "Incorrect Current Password", ToastLength.Long).Show(); return false; }
        ...
        protected void ReloadUserName()
        {
            ...
            mobileNum.Text = userMobileNum.ToString();
            edit_acc_name.Text = userData[0].Trim();
        }
